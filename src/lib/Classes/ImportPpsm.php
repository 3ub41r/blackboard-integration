...
class ImportPpsm extends AbstractImport
{
    ...
    public function processLecturers()
    {
        ...
        'PPSM_' + REPLACE(c.sesName, '/', '') + CAST(c.semNo AS VARCHAR) AS data_source_key,
    ...
    public function processCourses()
    {
        ...
        'PPSM_' + REPLACE(d.sesName, '/', '') + CAST(d.semNo AS VARCHAR) AS data_source_key
        FROM StuRegSubj a
    ...
    public function processCourseLecturers()
    {
        ...
        'instructor' AS [role],
        'PPSM_' + REPLACE(b.sesName, '/', '') + CAST(b.semNo AS VARCHAR) AS data_source_key
        FROM SubjOffered a
